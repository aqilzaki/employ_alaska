      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-xl mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
          ...
          <div className="md:col-span-2">
            <button 
              onClick={onAddClick}
              className="w-full bg-linear-to-r from-[#800020] to-[#a0002a] text-white px-4 py-3 rounded-xl font-medium text-sm hover:shadow-lg transition-all flex items-center justify-center gap-2"
            >
              <Plus size={18} />
              Tambah
            </button>
            ...
            >
              ...
              <div className="flex gap-2 pt-4 border-t border-gray-200">
                <button 
                  ...
                  className="flex-1 bg-gray-50/80 hover:bg-gray-100 text-gray-700 px-3 py-2 rounded-lg text-xs font-medium transition-all flex items-center justify-center gap-1"
                >
                  <Eye size={14} />
                  Detail
                </button>
                <button 
                  ...
                  className="flex-1 bg-blue-50 hover:bg-blue-100 text-blue-700 px-3 py-2 rounded-lg text-xs font-medium transition-all flex items-center justify-center gap-1"
                >
                  <Edit size={14} />
                  Edit
                </button>
                <button 
                  ...
                  className="bg-red-50 hover:bg-red-100 text-red-700 px-3 py-2 rounded-lg text-xs font-medium transition-all flex items-center justify-center"
                >
                  <Trash2 size={14} />
                </button>
              </div>
