...
const handleResponse = async (response) => {
  ...
  // Defensive: some backends return non-2xx status but still include created resource
  // (e.g. DB insert succeeded but an unrelated error occurred). If the body
  // clearly contains a created entity (has an `id`) or an explicit success flag,
